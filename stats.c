...
void main() {
  ...
  // Process Data
  sort_array(Array.array, Array.arrayLength);
  Array.min = find_min(Array.array, Array.arrayLength);
  Array.max = find_max(Array.array, Array.arrayLength);
  Array.mean = find_mean(Array.array, Array.arrayLength);
  Array.median = find_median(Array.array, Array.arrayLength);
  print_array(Array.array, Array.arrayLength);
